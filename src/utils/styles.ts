...
function toThemeValueIfNeeded<T>(propKey: string, value: T, theme?: AppTheme) {
  if (
    ...
    return theme.space[value as SpaceThemeKeys]
  } else if (
    theme &&
    theme.colors &&
    ...
    return theme.colors[value as ColorThemeKeys]
  } else if (
    theme &&
    theme.fontSizes &&
    ...
    return theme.fontSizes[value as FontSizeThemeKeys]
  } else if (
    theme &&
    ...
    return theme.letterSpacings[value as LetterSpacingThemeKeys]
  } else if (
    theme &&
    theme.lineHeights &&
    ...
    return theme.lineHeights[value as LineHeightThemeKeys]
  }
